...
;>>>>> begin main program code <<<<<
			...
			SUBS	R4,R1,R4 ;R4<-- 15-71
			
			
			MOVS	R1,#17  ;R1<--17
			ASRS	R2,R1,#DIV2 ;R2<---17/2
			
			MOVS 	R3,#5	;R3<--5
			MOVS	R1,#5	;R1<--5
			
			LSLS	R3,R1,#MULT4	;R3<--5x4
			ADDS	R3,R1,R3		;R3<-- R3+5
			
			
			ADDS	R5,R4,R2	;R5<-- R4+R2
			
			ADDS	R6,R5,R3	;R6<== R5+R3
			
			MOVS	R7,#42		;R7<--42
			
			ADDS	R7,R6,R7	;R7<-- R6+42
			
			MOVS	R0,#21		;R0<--21
			
			ADDS	R0,R7,R0	;R0<-- R7+21
